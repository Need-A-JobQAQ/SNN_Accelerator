...
module conv_lif_aer_tb();
    ...
    always @(posedge tb_clk or negedge tb_rst_n) begin
        if (!tb_rst_n) begin
            ...
            if (w_conv_lif_input_ready) begin
    ...
    generate
        if (P_FORCE_MULTICORE_CONV_LIF) begin : gen_multicore_conv_lif
            ...
            conv_lif_layer_sparse #(
                ...
                .i_input_spike_vector            (tb_input_spike_vector),
                .i_all_currents_I                (w_all_currents_I),
                .i_current_ram_rd_data           (w_current_ram_rd_data),
                .i_current_ram_rd_valid          (w_current_ram_rd_valid),
                .o_current_ram_rd_en             (w_current_ram_rd_en),
                .o_current_ram_rd_addr           (w_current_ram_rd_addr),
                .o_all_spikes_out                (w_all_spikes_out),
                .o_all_spikes_valid              (w_all_spikes_valid),
                .o_event_valid                   (w_conv_lif_event_valid),
                .o_event_addr                    (w_conv_lif_event_addr),
    ...
    initial begin
        ...
        tb_input_spike_vector = {28'b0000000000000000000000000000,
                                 ...
                                 28'b0000000000011111100011100000,
                                 28'b0000000000111110000111000000,
                                 28'b0000000001111000011100000000,
                                 28'b0000000111110001111000000000,
                                 28'b0000000111000011110000000000,
                                 28'b0000000110000001100000000000,
                                 28'b0000000011100110000000000000,
                                 28'b0000000111111110000000000000,
                                 28'b0000000000111111100000000000,
                                 28'b0000000000011111111000000000,
                                 28'b0000000000011100001000000000,
                                 ...
                                 28'b0000000000000110111000000000,
