...
module conv_layer_tb;
    ...
    wire tb_parallel_all_currents_valid;
    ...
    initial begin
        ...
        tb_input_spike_vector = {28'b0000000000000000000000000000,
                                 ...
                                 28'b0000000000000011100111100000,
                                 28'b0000000000001111000111100000,
                                 28'b0000000001111100000110000000,
                                 28'b0000000011110000011101000000,
                                 28'b0000000111100000111000000000,
                                 28'b0000001110000001110000000000,
                                 28'b0000001110000011100000000000,
                                 28'b0000000011100011000000000000,
                                 28'b0000000001111101000000000000,
                                 28'b0000000000111111100000000000,
                                 28'b0000000000011011111000000000,
                                 28'b0000000000011000011100000000,
        ...
        @(posedge tb_parallel_all_currents_valid);
        #50;
